...
def cross_validate_C(X, y):
    ...
    plt.savefig('Crossval_C.png', bbox_inches='tight')
...
'''
This functions starts the program. It runs the full analysis fore the first data set (including all output needed for the report) and then does the same for the second data set.
'''
def main():
    adhd_analysis(load_data('adhd_results.csv', 'adhdPart_results.csv'))
